...
window.torsepanPwa = {
  ...
  showMessage: function (title, message) {
    ...
    overlay.innerHTML = `<section class="pwa-help-dialog" dir="rtl"><img src="/icons/torsepan-logo-v3-192.png" alt="TORSEPAN"><h3>${title}</h3><p>${message}</p><button type="button">متوجه شدم</button></section>`;
